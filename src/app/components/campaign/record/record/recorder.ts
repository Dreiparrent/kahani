...
export class Recorder {
    ...
    <div id="playbackController" style="display: flex;"></div>`;
    ...
    constructor(private outer: HTMLDivElement, private index: number, private config: playConfig,
        private buttons: {
            ...
            stop: HTMLDivElement, slider: HTMLDivElement
    ...
    public listeners(listen: boolean) {
        ...
        this.player.on('finishRecord', () => {
            ...
            this._setButton(document.getElementById('playbackController'), VidButtons.slider);
...
enum VidButtons {
    record, pause, fullscreen, cam, stop, slider
}