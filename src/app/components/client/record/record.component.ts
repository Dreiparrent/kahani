...
import { ClientPrerecordComponent, IDialogData, IPreOutput } from './prerecord/prerecord.component';
...
export class ClientRecordComponent implements OnInit {
    @ViewChild('question') question: ClientQuestionComponent;
    ...
    recordReady(devices: MediaDeviceInfo[], initial: boolean, change = false) {
        ...
        if (initial) {
            ...
            const dialogRef = this.dialog.open<ClientPrerecordComponent<IBaseUserData>, IDialogData, IPreOutput<IBaseUserData>>(
